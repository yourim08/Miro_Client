...
class _CreateClassPageState extends State<CreateClassPage> {
  ...
  final String _coverImageUrl = 'assets/coverImg/cover.png'; // 🔥 고정된 URL
  ...
  bool get _isFormValid {
    return _className.isNotEmpty &&
        ...
        _coverImageFile != null; // 🔥 사진은 선택해야 함 (UI용)
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 8),
            InkWell(
              onTap: _selectCoverPhoto, // 🔥 업로드 대신 선택만
